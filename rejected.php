...
if ($_SESSION['ROLE']==1) {
    $sql="SELECT policy_tbl.*, users.name,policy_type.policy_type,users.id as eid FROM policy_tbl,policy_type, users where policy_tbl.policy_status=3 and policy_tbl.user_id=users.id and policy_tbl.policy_type=policy_type.id  order by policy_tbl.id desc";
    //$sql="SELECT * FROM policy_tbl order by id desc";
}else {
    $eid=$_SESSION['USER_ID'];
    $sql="SELECT policy_tbl.*, users.name,policy_type.policy_type,users.id as eid FROM policy_tbl,policy_type, users where policy_tbl.user_id='$eid' and policy_tbl.policy_status=3  and policy_tbl.user_id=users.id and policy_tbl.policy_type=policy_type.id order by policy_tbl.id desc";
}
