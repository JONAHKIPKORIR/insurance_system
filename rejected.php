...
if ($_SESSION['ROLE']==1) {
    $sql="SELECT policy_tbl.*, users.firstname,users.lastname,category.category,policy_type.policy_type,users.id as eid FROM policy_tbl,category,policy_type, users where policy_tbl.policy_status=3 and policy_tbl.user_id=users.id  /*policy_tbl.policy_type=policy_type.id*/  order by policy_tbl.id desc";
    //$sql="SELECT * FROM policy_tbl order by id desc";
}else {
    $eid=$_SESSION['USER_ID'];
    $sql="SELECT policy_tbl.*, users.firstname,users.lastname,category.category,policy_type.policy_type,users.id as eid FROM policy_tbl,category,policy_type, users where policy_tbl.policy_status=3 and policy_tbl.user_id=users.id and policy_tbl.user_id='$eid' /*policy_tbl.policy_type=policy_type.id*/ order by policy_tbl.id desc";
}
...
.box-content{
    cursor: pointer;
                ...
                <div class="table-heads">
                        <h3 class="table-title">Rejected Policies</h3>
                    ...
                    <table class="table">
                                <thead>
                                    <tr>
                                            ...
                                            <th width="5%">Insurance Category</th>
